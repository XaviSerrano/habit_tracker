...
// HabitStats.tsx — reemplaza el return completo

return (
  <div className="space-y-3" id="habit-stats-dashboard">
    
    {/* Key Stats — 2 columnas compactas */}
    <div className="bg-white border border-zinc-200 rounded-xl p-4 grid grid-cols-2 gap-3 shadow-sm">
      
      <div className="flex items-center gap-2.5 p-2.5 rounded-lg bg-zinc-50 border border-zinc-200/80 hover:border-zinc-300 transition">
        <div className="p-1.5 rounded bg-amber-500/10 text-amber-600 border border-amber-500/20">
          <Flame className="w-4 h-4" />
        </div>
        <div>
          <span className="text-[9px] font-mono tracking-wider text-zinc-500 uppercase block">Streak</span>
          <span className="text-lg font-bold text-zinc-900 tracking-tight block leading-none mt-0.5">
            {maxCurrentStreak}d
          </span>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2.5 p-2.5 rounded-lg bg-zinc-50 border border-zinc-200/80 hover:border-zinc-300 transition">
        <div className="p-1.5 rounded bg-violet-500/10 text-violet-600 border border-violet-500/20">
          <Trophy className="w-4 h-4" />
        </div>
        <div>
          <span className="text-[9px] font-mono tracking-wider text-zinc-500 uppercase block">Best</span>
          <span className="text-lg font-bold text-zinc-900 tracking-tight block leading-none mt-0.5">
            {maxLongestStreak}d
          </span>
        </div>
      ...
      <div className="col-span-2 flex items-center gap-2.5 p-2.5 rounded-lg bg-zinc-50 border border-zinc-200/80 hover:border-zinc-300 transition">
        <div className="p-1.5 rounded bg-zinc-900/10 text-zinc-900 border border-zinc-200">
          <Percent className="w-4 h-4" />
        </div>
        <div>
          <span className="text-[9px] font-mono tracking-wider text-zinc-500 uppercase block">Consistency</span>
          <span className="text-lg font-bold text-zinc-900 tracking-tight block leading-none mt-0.5">
            {avgCompletionRate}%
          </span>
        </div>
    ...
    <div className="bg-white border border-zinc-200 rounded-xl p-4 shadow-sm">
      <div className="flex justify-between items-center mb-3">
        <h3 className="text-[10px] font-semibold tracking-wider text-zinc-500 uppercase font-mono flex items-center gap-1.5">
          <TrendingUp className="w-3.5 h-3.5" />
          Consistency Matrix
        </h3>
        <span className="text-[9px] font-mono text-zinc-400">4 weeks</span>
      </div>

      <div className="grid grid-cols-7 gap-1" id="heatmap-grid">
        {last28Dates.map((dateStr, idx) => {
          ...
          return (
            <div
              key={dateStr}
              className={`aspect-square rounded-sm border ${intensityClass} transition-colors duration-300 relative group`}
            >
      ...
      <div className="flex items-center justify-end gap-1.5 text-[9px] text-zinc-400 font-mono mt-3">
        <span>Less</span>
        ...
        <div className="w-2 h-2 bg-zinc-400 border border-zinc-500 rounded-sm" />
        <div className="w-2 h-2 bg-zinc-700 border border-zinc-800 rounded-sm" />
